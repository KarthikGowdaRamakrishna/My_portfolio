...
<br/>
Welcome to my digital domain, where data and development converge into a symphony of innovation and insight! 
<br/> <br/><b>My Expertise</b><br/>

In my role as a <b>Sr Software Engineer/Analyst</b> at Capgemini, I've honed a unique set of skills, working across various industries to sculpt and streamline their digital landscapes. With over two years of intensive experience in data science and full stack web development, I've become a maestro of data-driven solutions. My toolbox is brimming with powerful instruments like <b>Tableau, Power BI, Python, PyTorch, scikit-learn, SQL</b> and advanced web development technologies including <b>React, JavaScript, TypeScript, and back-end frameworks like Express, Flask, and Django</b>.
<br/><br/>
<b>My Approach</b><br/>
...
As a full stack developer, I am not just coding applications; I'm crafting the very fabric of the digital experience. My work in advanced data science and web development at Northeastern University is more than academic pursuit; it's a quest to redefine the boundaries of what's possible. 
<br/><br/>
<b>Join Me</b><br/>


I invite you to join me on this thrilling journey as we reshape the world of business and technology. Together, we'll unlock new horizons, solve complex challenges, and sprinkle a dash of magic on the path to success. Let's revolutionize how the world interacts with data and technology, one project at a time.
